...
<section id="about">
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
            ...
            <div class="lg:py-24">
                <h2 class="text-3xl font-bold sm:text-4xl">Bienvenue</h2>
                ...
                <p class="mt-4 text-gray-600">Peu importe leur gabarit, du spitz nain au Patou des pyrénées,</p>
                <p class="mt-4 text-gray-600">Peu importe leur âge, du plus jeune au plus âgé,</p>
                ...
                <p class="mt-4 text-gray-600">Je me déplace chez vous, avec tout le matériel nécessaire pour toiletter votre compagnon dans les meilleures conditions qu’il soit.</p>
            </div>
        </div>
    </div>
</section>