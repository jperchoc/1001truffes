...
function Banner() {
  ...
  return (
    <section id="banner" className="relative">
      {
        images.map(img => 
          <div style={{backgroundImage: `url(${img})`}} className={`transition-opacity duration-1000 absolute bg-cover bg-center bg-no-repeat inset-0 ${images[shownImageIndex] === img ? "opacity-100":"opacity-0"}`} key={img}></div>
        )
      }
